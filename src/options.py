...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--add_loss', type=str, default='binary')
        self.parser.add_argument('--use_lora', action='store_true', help='use lora in the encoder')
        self.parser.add_argument('--add_fusion', type=str, default='qf_ds')
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument('--dist', action='store_true', help='use ddp')
        ...
        # training parameters
        self.parser.add_argument('--eval_freq', type=int, default=10000,
                        help='evaluate model every <eval_freq> steps during training')
        self.parser.add_argument('--start_eval', type=int, default=0,
                        help='start to evaluate after specific steps')
